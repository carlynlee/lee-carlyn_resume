...
\item Using Matlab, determined optimal decisional passes for Mars2020 Operations based on data volumes and pass schedules reported in TOAST output for Mars obiters. Developed HTML5 and javascript framework to generate and display Earth ground team schedules corresponding with decisional passes.
