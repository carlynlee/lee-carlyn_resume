...
\begin{rSubsection}{Oligo Space}{Jan 2025 - Present}{Head of Software Engineering}{}
\item Architected Zenith, an end-to-end spacecraft design automation framework connecting payload requirements to complete satellite configurations.
\item Developed automated pipelines for S-band, X-band, and UHF link budget analysis, regulatory filings (FCC Part 25 / ITU Appendix B \& C), and integration with commercial ground-station networks.
\item Integrated onboard networking components (SatCat5 FPGA switch, Arty A7-100T, Raspberry Pi-based data paths) for payload developer kits and flight-software interfaces.
\item Designed internal tooling to support rapid spacecraft iteration, GMAT-based orbit analysis, and reinforcement-learning prototypes for structural mass-model optimization.
\end{rSubsection}
...
Perseverance Rover telecom chair, responsible for rover communications health using data from Mars. Delivered tools reducing operation response-time from several hours to 20 minutes.
...
\item {\bf{Fieldwork:}} 
Reliable multi-agent data transfer processes at transport layer. Field tested autonomous systems in maritime and subterranean environments, contributing to 1st place in DARPA's Urban Circuit Challenge.
...
\item {\bf 2019 - Present} Global Network Advancement (GNA-G) Data Intensive Sciences Working Group, enabling high-throughput data transfers for Caltech, SCIinet demonstration at Supercomputing 24-25.
