...
\item Developed Tableau Web Data Connectors and dashboards for exploring aggregated Event Verification Records \& Engineering Housekeeping and Accountability data from anomolies flagged by rules-engine. 
\item Using Matlab, determined optimal decisional passes for MSL Operations based on data volumes and pass schedules reported in TOAST output for Mars obiters. Developed HTML5 and javascript framework to generate and display Earth ground team schedules corresponding with decisional passes.
