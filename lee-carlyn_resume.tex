...
\address{(626)~$\cdot$~419~$\cdot$~6597 \\ carlyn.lee@gmail.com} % Your phone number and email
...
\item Java and nodejs implementations of telecom link analysis API based on models described in  810-005 DSN Telecommunications Link Design Handbook.
