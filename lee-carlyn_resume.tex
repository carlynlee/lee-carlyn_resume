...
\item Enabled concurrent simulations of Serially Concatenated Pulse-Position Modulation on Cray XC40 supercomputer and simulated bit error rates as low as 10e-9. Integration and development of Link Performance \& SNR calculation and Data Volume modeling tools for concurrent link analyses in M2020 Relay Telecom Predictor.

\item Communications support for collaborative multi-agent autonomy in maritime and subterranean environments. V\&V for  software on networked Raspberry Pi's and unmanned surface vehicles.  Trade studies and implementation of radio mesh network in mining tunnel, which improved robot localization in GPS/comm deprived environments, and resulted in 1st place in DARPA's Subterranean Challenge Urban Circuit.

\item Developed intelligent interfaces for DSN operators and telecom engineers to plan and execute telemetry, tracking, command, and montiring of spacecraft. Implemented framework for Link Complexity and Maintenance software to query events \& trends from Sequence of Events files and estimate a link complexity profile, which increased the efficiency of support to NASA deep-space missions. Architected data delivery systems for COTS dashboards which enables operators to explore aggregated data and event anomalies flagged by rules-engine, Event Verification Records \& Engineering Housekeeping, and Accountability data. e.g. Tableau \& Web Data Connectors, Kibana.
